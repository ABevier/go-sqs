module github.com/abevier/go-sqs

go 1.18

require (
	github.com/abevier/tsk v0.0.0-00010101000000-000000000000
...
replace github.com/abevier/tsk => /Users/alanbevier/Projects/go-tasks
